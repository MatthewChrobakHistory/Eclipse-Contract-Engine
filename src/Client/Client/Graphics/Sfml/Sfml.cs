...
namespace Client.Graphics.Sfml
{
    public class Sfml : IGraphics
    {
            ...
            this.DrawingSurface.Closed += (sender, e) => {
                switch (Program.State) {
                    case ClientState.Game:
                        Networking.NetworkManager.PacketManager.SendRequestLeaveGame();
                        break;
                    case ClientState.MainMenu:
                        Program.SetClientFlag(ClientFlag.Closing);
                        break;
                }
            };
        }
        ...
        private void LoadFont() {
            string fontFile = GraphicsManager.FontPath + "friz.ttf";
        ...
        public void ShowMessage(string message) {
            SceneSystem.ShowMessage(message);
        }
        #endregion
